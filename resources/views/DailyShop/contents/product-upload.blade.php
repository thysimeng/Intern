                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <div class="aa-product-view-content">
                                        ...
                                        <input type="text" name="shortDescription" placeholder="Product Short Description">
                                        <h4>Size</h4>
                                        ...
                                        <div class="aa-prod-quantity">
                                            <p class="aa-prod-category">
                                                ...
                                                <select id="" name="catagegory">
                                                    <option selected="1" value="all">All</option>
                                        ...
                                        <div class="aa-product-view-content">
                                            {{--<h3>T-Shirt</h3>--}}
                                            <textarea name="longDescription" id="" cols="30" rows="10" placeholder="Description"></textarea>
                                            <div class="aa-price-block">
